...
@section('title', 'Configuration of NextGen')
    ...
    <div class="card shadow">
        <div class="card-body">
            <form action="{{ route('admin.themes.config', $theme) }}" method="POST" id="configForm">
                ...
                <div class="mb-3">
                    <label class="form-label" for="footerDescriptionInput">{{ trans('theme::nextgen.config.news_description') }}</label>
                    <textarea class="form-control @error('news_description') is-invalid @enderror" id="footerDescriptionInput" name="news_description" rows="3">{{ old('news_description', theme_config('footer_description')) }}</textarea>
                ...
                <div class="mb-3">
                    <label class="form-label" for="footerDescriptionInput">{{ trans('theme::nextgen.config.footer_description') }}</label>
                ...
                <label class="form-label">{{ trans('theme::nextgen.config.footer_links') }}</label>
